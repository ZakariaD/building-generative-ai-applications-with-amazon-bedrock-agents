...
def lambda_handler(event, context):
    """Lambda handler for Adzuna job search"""
    try:
        ...
        if tool_name == 'search_adzuna_jobs':
            result = search_adzuna_jobs(**params)
        elif tool_name == 'get_adzuna_salary_stats':
            result = get_adzuna_salary_stats(**params)
        elif tool_name == 'get_adzuna_job_categories':
            result = get_adzuna_job_categories(**params)
        elif tool_name == 'get_adzuna_top_companies':
            result = get_adzuna_top_companies(**params)
        elif tool_name == 'search_adzuna_by_location':
            result = search_adzuna_by_location(**params)
        elif tool_name == 'get_adzuna_job_details':
            result = get_adzuna_job_details(**params)
        elif tool_name == 'search_adzuna_geodata':
            result = search_adzuna_geodata(**params)
        elif tool_name == 'get_adzuna_salary_chart':
            result = get_adzuna_salary_chart(**params)
        else:
