for log_group in "/aws/lambda/ap-multi-agents-classification" "/aws/lambda/ap-multi-agents-orchestrator" "/aws/lambda/ap-multi-agents-customer" "/aws/lambda/ap-multi-agents-routing" "/aws/lambda/ap-multi-agents-extraction"; do
