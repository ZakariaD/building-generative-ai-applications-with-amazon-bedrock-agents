...
def route_invoice(params):
    original_subject = params.get('original_subject')
    original_body = params.get('original_body')
    supplier_id = params.get('supplier_id')
    intent_code = params.get('intent_code')
    recipient_email = params.get('recipient_email')
    invoice_numbers_str = params.get('invoice_numbers', '[]')
...
---
Processed by AP Invoice Routing System (AgentCore)
  ...
  <div class="metadata-section">
    ...
    <div class="metadata-grid">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">{intent_code}</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-label">Invoice Number</div>
        <div class="metadata-value">{invoice_number if invoice_number else 'N/A'}</div>
      </div>
      <div class="metadata-item">
    ...
    <div class="footer">
      Powered by Amazon Bedrock AgentCore | AP Invoice Routing System
    </div>
  </div>
</body>
</html>
